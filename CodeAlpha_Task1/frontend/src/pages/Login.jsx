        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '80vh' }}>
            ...
            <div className="auth-form" style={{ marginTop: 0, width: '100%' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn-primary" style={{ width: '100%', marginTop: '10px', fontSize: '1.1rem' }}>Sign In to Shop</button>
                </form>
                <p className="text-center mt-4" style={{ color: 'var(--text-secondary)' }}>
                    Don't have an account? <Link to="/register" style={{ color: 'var(--accent-color)', fontWeight: 700 }}>Register here</Link>
                </p>
            </div>
        </div>
    );
